...
namespace application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                Environment.SetEnvironmentVariable("DB_CONNECTION", "Persist Security Info=True;Server=DESKTOP-N4S8L6T;Initial Catalog=DBApi_Integration;MultipleActiveResultSets=true;User ID=root;Password=1234");
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Curso de API com AspNetcore 3.1 core",
                ...
                {
                    Description = "Enter com o Token JWT",
                    Name = "Authorization",
